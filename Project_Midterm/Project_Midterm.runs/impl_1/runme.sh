...
HD_PWD='C:/Users/sonal/Documents/GitHub/ECE540_Project2/Project_Midterm/Project_Midterm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log question_C.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source question_C.tcl -notrace
