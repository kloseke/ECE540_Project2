...
HD_PWD='C:/Users/sonal/Documents/GitHub/ECE540_Project2/Project_Midterm/Project_Midterm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log question_C.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source question_C.tcl
