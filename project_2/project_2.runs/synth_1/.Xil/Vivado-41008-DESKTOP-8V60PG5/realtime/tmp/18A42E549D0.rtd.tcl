...
set genomeRtd $env(RT_TMP)/18A42E549D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {swervolf_core__GCB0}]"
...
set genomeName [subst -nocommands -novariables {swervolf_core__GCB0}]
