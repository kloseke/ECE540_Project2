...
set genomeRtd $env(RT_TMP)/14705B41F20.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {swervolf_core__GCB1}]"
...
set genomeName [subst -nocommands -novariables {swervolf_core__GCB1}]
