...
#
# Generated by export_simulation on Thu Feb 25 02:27:17 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './Bot_Icon.sh' script.

./Bot_Icon.sh -reset_run
...
./Bot_Icon.sh -noclean_files

For more information on the script, please type './Bot_Icon.sh -help'.
