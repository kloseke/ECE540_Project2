...
#
# Generated by Vivado on Sun Feb 21 21:00:57 -0800 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../project_2.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../project_2.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
